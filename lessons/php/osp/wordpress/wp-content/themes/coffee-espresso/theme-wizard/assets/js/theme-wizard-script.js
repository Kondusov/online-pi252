var Whizzie = (function($) {
  ...
  function PluginManager() {
        ...
        if (typeof response.url != 'undefined') {
          ...
          if (response.hash == current_item_hash) {
            ...
            jQuery.post(response.url, response, function(response2) {
              process_current();
              $current_node.find('span').text(response.message + coffee_espresso_whizzie_params.verify_text);
            }).fail(ajax_callback);
          }
    ...
    function process_current() {
      if (current_item) {
        ...
        jQuery.post(coffee_espresso_whizzie_params.ajaxurl, {
          action: 'setup_plugins',
          wpnonce: coffee_espresso_whizzie_params.wpnonce,
          slug: current_item
  ...
  function WidgetManager() {
    function import_widgets() {
      jQuery.post(
        coffee_espresso_whizzie_params.ajaxurl, {
...
jQuery(document).ready(function() {
  ...
  jQuery('#at-setup-menu').click(function() {
    jQuery('#at-demo-setup-guid .at-setup-menu').css("display", "block");
    jQuery('#at-demo-setup-guid .at-setup-contact').css("display", "none");
    jQuery('#at-demo-setup-guid .at-setup-widget').css("display", "none");
  });

  jQuery('#at-setup-contact').click(function() {
    jQuery('#at-demo-setup-guid .at-setup-menu').css("display", "none");
    jQuery('#at-demo-setup-guid .at-setup-contact').css("display", "block");
    jQuery('#at-demo-setup-guid .at-setup-widget').css("display", "none");
  });
  ...
  jQuery('#at-setup-widget').click(function() {
    jQuery('#at-demo-setup-guid .at-setup-menu').css("display", "none");
    jQuery('#at-demo-setup-guid .at-setup-contact').css("display", "none");
    jQuery('#at-demo-setup-guid .at-setup-widget').css("display", "block");
  });
});