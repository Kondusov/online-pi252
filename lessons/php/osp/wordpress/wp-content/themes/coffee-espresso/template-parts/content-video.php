        ...
        <?php
			...
			if (!empty($coffee_espresso_embeds)) {
			    ...
			    foreach ($coffee_espresso_embeds as $coffee_espresso_embed) {
			        ...
			        if (strpos($coffee_espresso_embed, 'video') !== false || strpos($coffee_espresso_embed, 'youtube') !== false || strpos($coffee_espresso_embed, 'vimeo') !== false || strpos($coffee_espresso_embed, 'dailymotion') !== false || strpos($coffee_espresso_embed, 'vine') !== false || strpos($coffee_espresso_embed, 'wordPress.tv') !== false || strpos($coffee_espresso_embed, 'hulu') !== false) {
			            ?>
